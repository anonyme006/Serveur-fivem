-- qbx_rp_core — tables complémentaires (player_vehicles reste celle de QBox)

CREATE TABLE IF NOT EXISTS `qbx_rp_core_keys` (
...
CREATE TABLE IF NOT EXISTS `qbx_rp_core_covers` (
...
CREATE TABLE IF NOT EXISTS `qbx_rp_core_used_parking` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `qbx_rp_core_antennas` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `owner` VARCHAR(60) NOT NULL,
  `label` VARCHAR(80) DEFAULT NULL,
