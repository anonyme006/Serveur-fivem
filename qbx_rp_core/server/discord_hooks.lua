--[[
    Hooks logs Discord — événements serveur + bridge qbx_rp_core
]]
...
AddEventHandler('onResourceStop', function(res)
    if res == GetCurrentResourceName() then
        log('system', '🔴 qbx_rp_core stoppé', nil, { color = 'error' })
        return
    end
...
--- Events internes qbx_rp_core (émis depuis les modules)
AddEventHandler('qbx_rp_core:log', function(category, title, description, opts)
