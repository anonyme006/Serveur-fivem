RegisterCommand(Config.Command, function()
    ...
    if lib.progressCircle({
        ...
        TriggerEvent('vibe_playerstats:client:add', 'hunger', Config.HungerGain)
        TriggerEvent('vibe_playerstats:client:add', 'thirst', Config.ThirstGain)
        exports.vibe_api:Notify('Repos', 'Tu te sens un peu mieux.', 'success')
    end
end, false)
