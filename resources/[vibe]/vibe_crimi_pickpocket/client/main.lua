    ...
    exports.ox_target:addGlobalPed({
        {
            ...
            onSelect = function(data)
                if GetGameTimer() - last < Config.Cooldown * 1000 then
                    exports.vibe_api:Notify('Pickpocket', 'Trop tôt.', 'error')
                    return
                end
                if lib.progressCircle({
                    ...
                    TriggerServerEvent('vibe_crimi_pickpocket:server:steal', { x = coords.x, y = coords.y, z = coords.z })
                end
            end,
        },
    })
