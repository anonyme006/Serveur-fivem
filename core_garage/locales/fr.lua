...
Locales['fr'] = {
    ...
    -- MenuV
    ['menuv_garage_subtitle'] = 'Sortir ou ranger un véhicule',
    ['menuv_impound_subtitle'] = 'Récupérer un véhicule en fourrière',
    ['menuv_my_vehicles'] = 'Mes véhicules',
    ['menuv_my_vehicles_desc'] = 'Liste de vos véhicules disponibles',
    ['menuv_vehicle_list'] = 'Sélectionnez un véhicule',
    ['menuv_store_desc'] = 'Ranger le véhicule le plus proche',
    ['menuv_admin_subtitle'] = 'Gestion des garages',
    ['menuv_admin_list'] = 'Liste des garages',
    ['menuv_admin_list_sub'] = 'Sélectionnez un garage',
    ['menuv_admin_list_desc'] = 'Voir et modifier les garages',
    ['menuv_admin_actions'] = 'Actions garage',
    ['menuv_admin_actions_sub'] = 'Modifier ce garage',
    ['menuv_admin_create'] = 'Créer un garage',
    ['menuv_admin_create_desc'] = 'Créer un nouveau garage',
    ['menuv_admin_create_impound'] = 'Créer une fourrière',
    ['menuv_admin_create_impound_desc'] = 'Ajouter une fourrière',
    ['menuv_admin_create_company'] = 'Créer garage entreprise',
    ['menuv_admin_create_company_desc'] = 'Garage partagé entreprise',
    ['menuv_admin_move'] = 'Déplacer (position menu)',
    ['menuv_admin_spawn'] = 'Définir spawn véhicule',
    ['menuv_admin_store'] = 'Définir point de retour',
    ['menuv_admin_blip'] = 'Configurer blip',
    ['menuv_admin_edit'] = 'Modifier',
    ['menuv_admin_delete'] = 'Supprimer',
    ['menuv_admin_enable'] = 'Activer',
    ['menuv_admin_disable'] = 'Désactiver',
}
