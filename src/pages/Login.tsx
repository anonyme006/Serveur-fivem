  ...
  return (
    <div className="login-page app-shell">
      <div className="skyline-bg" aria-hidden="true">
        <Skyline className="skyline-bg__art login__skyline" />
      </div>

      <main className="login__main">
        <div className="login__card">
          <div className="login__brand">
            <Logo size={88} framed className="login__die" />
            <div>
              <h1>
                <span>RE</span>
                <span className="login__roll">ROLL</span>
              </h1>
              <p className="login__tagline">Mourir n&apos;est plus un choix</p>
            </div>
          </div>
