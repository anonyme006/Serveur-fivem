...
RegisterNetEvent('qbx_ressources:duty:client:updateBlips', function(employees)
    syncBlips(employees)
end)

RegisterNetEvent('qbx_ressources:duty:client:updateCoords', function(coordsMap)
...
RegisterNetEvent('qbx_ressources:duty:client:removeBlip', function(serverId)
...
exports('RefreshBlips', function()
    TriggerServerEvent('qbx_ressources:duty:server:requestBlipSync')
end)
