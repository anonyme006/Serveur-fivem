...
-- SQL unifié chargé par server/core/main.lua (duty_logs inclus)
...
AddEventHandler('playerDropped', function()
    ...
    TriggerClientEvent('qbx_ressources:duty:client:removeBlip', -1, src)
...
local function onJobUpdate(src)
    ...
    Duty.SyncViewer(src)
    Duty.BroadcastBlipRefresh(affected)
    TriggerClientEvent('qbx_ressources:duty:client:jobChanged', src, entry and entry.job or nil)
end
...
print('^2[qbx_ressources:duty]^0 système de service global chargé')
