...
-- Compatible : qbx_concessionnaire + qbx_garage
-- États : 0 = sorti | 1 = garage | 2 = fourrière
-- =========================================================
...
-- Optionnel : clé étrangère vers players (décommente si ta table players existe)
-- ALTER TABLE `player_vehicles`
--   ADD CONSTRAINT `fk_player_vehicles_citizenid`
